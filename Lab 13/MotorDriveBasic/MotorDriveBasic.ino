/*
Example sketch 12 SparkFun Motor Driver
Use the SparkFun Motor Driver to control the speed and direction of a motor. 
The motor driver allows us to control the direction and speed of the motor.
*/
...
void loop()
{
   //These statements drive forward the motor at full speed by putting DIR_A High
